...
const specialziedBoards: SpecializedBoard[] = [
  {
  ...
  },
  {
    ...
    description:
      "These boards all have a single amount greater than $1,000,000 on them in addition to the $1,000,000 prize",
  },
  {
  ...
  },
  {
    ...
    leftCases: [.01, 1,5,10,25,50,100,200,300,400,500],
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] text-center">
          ...
          <div className="grid gap-4 py-4">
            {specialziedBoards.map((board, index) => (
              <div key={index} className="relative">
                ...
                {board.description && activeTooltip === index && (
                  <div className="absolute z-50 p-2 text-sm bg-secondary text-secondary-foreground rounded shadow-md bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64">
                    {board.description}
                  </div>
                )}
              </div>
      ...
      <Dialog open={millionDollarDialogOpen} onOpenChange={setMillionDollarDialogOpen}>
        <DialogContent className="sm:max-w-[425px] text-center">
          ...
          <div className="grid gap-4 py-4">
            ...
            <Button onClick={handleMillionDollarConfirm} className="mx-auto">
              Confirm
            </Button>
          </div>
        </DialogContent>
        ...
        <DialogContent className="sm:max-w-[425px] text-center">
          ...
          <div className="grid gap-4 py-4">
            {seasonOnePremierWeekBoards.map((board, index) => (
              <Button key={index} onClick={() => handleSeasonOnePremiereWeekConfirm(board)} className="w-full">
                {board.name}
              </Button>
            ))}
          </div>
        ...
        <DialogContent className="sm:max-w-[425px] text-center">
          ...
          <div className="grid gap-4 py-4">
            {seasonTwoPremierWeekBoards.map((board, index) => (
              <Button key={index} onClick={() => handleSeasonTwoPremiereWeekConfirm(board)} className="w-full">
                {board.name}
              </Button>
            ))}
          </div>
